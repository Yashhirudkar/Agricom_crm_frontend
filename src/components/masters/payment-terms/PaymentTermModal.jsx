      ...
      <form onSubmit={onSubmit} className="p-6 space-y-5">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              className={inp}
              placeholder="e.g. 100_CAD"
            />
          </div>
          <div>
            <label className={lbl}>Term Name <span className="text-red-500">*</span></label>
            <input
              type="text"
              required
              value={form.name}
        ...
        <div className="pt-4 flex justify-end gap-3 border-t border-gray-100">
          ...
          >
            ...
            {isEditMode ? "Save Changes" : "Create Payment Term"}
          </button>
        </div>
      </form>
    </Modal>

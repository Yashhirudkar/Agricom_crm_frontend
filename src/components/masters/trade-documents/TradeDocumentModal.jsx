...
export default function TradeDocumentModal({
  isOpen,
  onClose,
  onSubmit,
  form,
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      title={isEditMode ? "Edit Trade Document" : "Create Trade Document"}
      size="md"
    >
      <form onSubmit={onSubmit} className="p-6 space-y-5">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className={lbl}>Document Code <span className="text-red-500">*</span></label>
            <input
              type="text"
              required
              value={form.code}
          ...
          <div>
            <label className={lbl}>Document Name <span className="text-red-500">*</span></label>
            <input
              type="text"
              required
              value={form.name}
        ...
        <div className="pt-4 flex justify-end gap-3 border-t border-gray-100">
          ...
          >
            ...
            {isEditMode ? "Save Changes" : "Create Trade Document"}
          </button>
        </div>
      </form>
    </Modal>

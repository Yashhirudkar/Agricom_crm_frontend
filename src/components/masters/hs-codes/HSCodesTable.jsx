...
export default function HSCodesTable({ hscodes, openEditModal, setDeleteTarget, setRestoreTarget, setPermanentDeleteTarget }) {
  return (
                ...
                <td className="px-6 py-4 text-right space-x-2">
                  {item.isActive ? (
                    ...
                    <>
                      ...
                      <HasPermission permission="hscode:force_delete">
                        <button

...
export default function FinancialYearModal({
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      title={isEditMode ? "Edit Financial Year" : "Create Financial Year"}
      size="md"
    >
      <form onSubmit={onSubmit} className="p-6 space-y-5">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className={lbl}>Year (e.g., 2026-27) <span className="text-red-500">*</span></label>
            <input
              type="text"
              required
              value={form.year}
        ...
        <div className="pt-4 flex justify-end gap-3 border-t border-gray-100">
          ...
          >
            ...
            {isEditMode ? "Save Changes" : "Create Financial Year"}
          </button>
        </div>
      </form>
    </Modal>

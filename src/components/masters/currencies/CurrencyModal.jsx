...
export default function CurrencyModal({
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      title={isEditMode ? "Edit Currency" : "Create Currency"}
      size="md"
    >
      <form onSubmit={onSubmit} className="p-6 space-y-5">
        ...
        <div>
          <label className={lbl}>Currency Name <span className="text-red-500">*</span></label>
          <input
            type="text"
            required
            value={form.name}
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className={lbl}>Currency Code <span className="text-red-500">*</span></label>
            <input
              type="text"
              required
              value={form.code}

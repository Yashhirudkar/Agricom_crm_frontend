...
export default function ShipmentTypesTable({
  shipmentTypes,
  openEditModal,
  setDeleteTarget,
  setRestoreTarget,
            ...
            <tr>
              <td colSpan="4" className="px-6 py-12 text-center">
                <div className="flex flex-col items-center justify-center text-gray-400">
                  <p className="text-sm font-medium text-gray-500">No shipment types found</p>
              ...
              <tr key={st.id} className="hover:bg-blue-50/30 transition-colors group">
                ...
                <td className="px-6 py-4">
                  <div className="flex items-center justify-end gap-2 transition-opacity">
                    <HasPermission permission="shipmenttype:edit">
                      <button
                    ...
                    {st.status === "Active" ? (
                      <HasPermission permission="shipmenttype:delete">
                        <button
                      ...
                      <>
                        ...
                        <HasPermission permission="shipmenttype:delete">
                          <button
                            onClick={() => setPermanentDeleteTarget(st)}

...
export default function CategoriesFilters({ search, setSearch, isActiveFilter, setIsActiveFilter, setCurrentPage, totalCount }) {
  const [localSearch, setLocalSearch] = useState(search);

  // Debounce logic to prevent firing API on every keystroke
  useEffect(() => {

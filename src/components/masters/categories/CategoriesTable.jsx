...
export default function CategoriesTable({ categories, openEditModal, setDeleteTarget, setRestoreTarget, setPermanentDeleteTarget }) {
  return (
                ...
                <td className="px-6 py-4 text-right space-x-2">
                  {category.isActive ? (
                    ...
                    <>
                      ...
                      <HasPermission permission="category:force_delete">
                        <button

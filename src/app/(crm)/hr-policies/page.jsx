  ...
  useEffect(() => {
    if (currentPolicy) {
      setForm({
        ...
        defaultBreakStartTime: currentPolicy.defaultBreakStartTime || "13:00",
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-xs overflow-hidden">
          ...
          <div className="p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <TimePicker12h
              ...
              onChange={(val) => setForm({ ...form, defaultShiftStartTime: val })}
            />
            ...
            <TimePicker12h
              ...
              onChange={(val) => setForm({ ...form, defaultShiftEndTime: val })}
            />
            ...
            <TimePicker12h
              ...
              onChange={(startVal) => {
                const endVal = form.defaultBreakEndTime;
                let mins = form.defaultBreakMinutes;
                if (startVal && endVal) {
                ...
                setForm({ ...form, defaultBreakStartTime: startVal, defaultBreakMinutes: mins });
              }}
            />
            ...
            <TimePicker12h
              ...
              onChange={(endVal) => {
                const startVal = form.defaultBreakStartTime;
                let mins = form.defaultBreakMinutes;
                if (startVal && endVal) {
                  const [sH, sM] = startVal.split(":").map(Number);
                  const [eH, eM] = endVal.split(":").map(Number);
                ...
                setForm({ ...form, defaultBreakEndTime: endVal, defaultBreakMinutes: mins });
              }}
            />
            <div>
              ...
              <input
                ...
                className="w-full border border-gray-200 rounded-xl px-3 py-2 text-xs focus:ring-1 focus:ring-[#007aff] outline-none text-gray-700 disabled:bg-gray-50 disabled:text-gray-400 disabled:cursor-not-allowed bg-slate-50 font-semibold"
                readOnly
              />
            </div>
            <div>

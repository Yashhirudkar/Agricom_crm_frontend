  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden animate-in fade-in duration-500 delay-100">
      <div className="p-6 md:p-8 border-b border-slate-100 flex items-center justify-between">
        ...
        {!isEditing ? (
          ...
          <div className="flex items-center gap-2">
            <button onClick={() => setIsEditing(false)} className="text-sm font-bold text-slate-500 hover:text-slate-700 px-4 py-2 rounded-xl transition-all flex items-center gap-2">
      ...
      <div className="p-6 md:p-8 space-y-8">
        ...
        {/* Personal Details */}
        <div>
          <h4 className="text-sm font-bold text-slate-800 mb-4 border-b border-slate-50 pb-2">Basic Details</h4>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <InputField label="Employment Type" value={employee?.employmentType?.replace('_', ' ')} locked={true} />
            <InputField label="Joining Date" value={employee?.joiningDate} locked={true} />
        ...
        {/* Contact Details */}
        <div>
          <h4 className="text-sm font-bold text-slate-800 mb-4 border-b border-slate-50 pb-2">Contact Details</h4>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {/* Emergency Contact */}
        <div>
          <h4 className="text-sm font-bold text-slate-800 mb-4 border-b border-slate-50 pb-2">Emergency Contact</h4>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">

      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-6 justify-between">
        ...
        <div className="flex items-center gap-4">
          <div className="relative shrink-0">
            <div
              className={`h-16 w-16 rounded-xl bg-slate-50 border border-slate-200 flex items-center justify-center overflow-hidden relative group transition-all duration-300 ${user?.avatarUrl ? 'cursor-pointer hover:border-[#007aff] hover:shadow-md' : ''
                }`}

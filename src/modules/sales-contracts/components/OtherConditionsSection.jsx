...
const DEFAULT_OTHER_CONDITIONS = [
  "Weight Difference: +/- 5% at seller's option at contract price.",
  "Quality Claims: Must be submitted within 15 days of arrival at destination port.",
  "Inspection: By SGS or equivalent at loading port, final at destination.",
];

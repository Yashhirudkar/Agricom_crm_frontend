...
export default function PurchaseDocuments({
  ...
  if (loading) {
    return (
      <div className="bg-white border border-gray-200 rounded-2xl p-8 text-center animate-pulse">
        ...
        <span className="text-xs font-semibold text-gray-500">Loading document checklist...</span>
      </div>
    );
  }
  ...
  // Available master trade documents not yet added
  ...
  return (
    <div className="space-y-6">
      {/* Top Banner: Progress Bar + Add Required Document Button */}
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div>
            <h3 className="text-xs font-bold text-gray-900 uppercase tracking-wider flex items-center gap-2">
              ...
              Document Compliance Checklist ({uploadedCount}/{totalCount} Completed)
            </h3>
            <p className="text-[11px] text-gray-500 mt-0.5">
              Required operational trade documents for contract execution & clearance.
            </p>
          </div>

          <div className="flex items-center gap-3">
            <span className="text-xs font-bold text-teal-700 font-mono bg-teal-50 px-2.5 py-1 rounded-lg border border-teal-100">
                  ...
                  <tr key={doc.id} className="hover:bg-teal-50/30 transition-colors">
                    ...
                    <td className="px-4 py-3 font-mono text-gray-600 max-w-[200px] truncate">
                      {attachment ? (
                        ...
                        <span className="text-gray-300 italic">No file uploaded</span>
                      )}
                    </td>
              ...
              {documents.length === 0 && (
                <tr>
                  <td colSpan={5} className="text-center py-12 text-gray-400">
                    ...
                    <p className="text-xs font-semibold text-gray-600">No document checklist items registered</p>
                    <p className="text-[11px] text-gray-400 mt-1">
                      Click "Add Required Document" to attach trade document slots to this contract.
                    </p>
                  </td>
                </tr>
              )}
        ...
        <div className="fixed inset-0 z-50 bg-black/40 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-xl border border-gray-200 w-full max-w-md p-6 space-y-4 animate-in fade-in zoom-in-95 duration-150">
            <h3 className="text-sm font-bold text-gray-900 flex items-center gap-2">
              ...
              Upload Document: {selectedDocForUpload.tradeDocument?.name}
            </h3>
      ...
      {showAddDocModal && (
        <div className="fixed inset-0 z-50 bg-black/40 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-xl border border-gray-200 w-full max-w-md p-6 space-y-4 animate-in fade-in zoom-in-95 duration-150">
            ...
            <p className="text-xs text-gray-500">
              Select a trade document type from the master list to enforce compliance.
            </p>

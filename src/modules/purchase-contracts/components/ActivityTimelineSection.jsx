...
export default function ActivityTimelineSection({ contractId }) {
  ...
  if (isLoading) {
    return (
      <div className="bg-white border border-gray-200 rounded-2xl p-8 text-center animate-pulse">
        ...
        <span className="text-xs font-semibold text-gray-500">Loading operational activity stream...</span>
      </div>
    );
  }
      ...
      <div className="flex items-center justify-between border-b border-gray-100 pb-3">
        <div>
          <h3 className="text-xs font-bold text-gray-900 uppercase tracking-wider flex items-center gap-2">
            ...
            Operational Log Stream & Event Trail
          </h3>
          <p className="text-[11px] text-gray-500">
            Real-time audit log of operational actions performed on this execution contract.
          </p>
        </div>
      ...
      <div className="space-y-3">
        {activities.map((act) => {
          ...
          return (
            <div
              key={act.id}
              className="flex items-start gap-3.5 p-3.5 rounded-xl border border-gray-100 hover:border-purple-200 hover:bg-purple-50/20 transition-all"
            >
        ...
        {activities.length === 0 && (
          <div className="text-center py-12 text-gray-400">
            ...
            <p className="text-xs font-semibold text-gray-600">No operational activities logged yet</p>
            <p className="text-[11px] text-gray-400 mt-1">
              Events will be automatically recorded as dispatches and documents are updated.
            </p>
          </div>
        )}
      </div>
